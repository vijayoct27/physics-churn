...
In https://nbviewer.jupyter.org/github/vijayoct27/physics-churn/blob/master/inspire_data_cleaning.ipynb, we first clean the data (e.g. dealing with different authors with the same name or multiple names for the same author). 
...
Next in https://nbviewer.jupyter.org/github/vijayoct27/physics-churn/blob/master/inspire_eda.ipynb we explore the data. 
...
Finally in https://nbviewer.jupyter.org/github/vijayoct27/physics-churn/blob/master/inspire_model.ipynb we build a benchmark model and analyze its results. 
...
One major shortcoming with the model is it tends to give excessiely high churn probabilities for grad students. 
